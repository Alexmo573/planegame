...
class mediapipe_gestuer_helper():
    ...
    def get_last_hand_info(self,show_cord=True,show_landmark=True):
        ...
        if len(recognition_result.hand_landmarks) >0:
            ...
            if show_cord:
                cv2.putText(detect_image, str(recognition_result.gestures[0][0].category_name), (10, 100), cv2.FONT_HERSHEY_PLAIN, 3, (255, 0, 255), 3)
            ...
            return (recognition_result.gestures[0][0].category_name,x,y,z)
